            ...
            <div class="orders">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">Candidate Status Wise Report</h4>
                            </div>
                            <div class="card-body--">
                                <div class="container mb-2">
                                    <div class="row">
                                        <div class="col-sm-6" wire:ignore>
                                            <select id="select-state" multiple placeholder="select status .."
                                                autocomplete="off" wire:model.lazy="selectedStatus">
