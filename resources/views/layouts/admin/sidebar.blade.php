              ...
              <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                      ...
                      <ul class="sub-menu children dropdown-menu">
                          <li><i class="fa fa-puzzle-piece"></i><a href="ui-buttons.html">All Jobs</a></li>
                          <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">New Jobs</a></li>
                          <li><i class="fa fa-bars"></i><a href="ui-tabs.html">Completed Jobs</a></li>
                          <li><i class="fa fa-bars"></i><a href="ui-tabs.html">Active Jobs</a></li>
                          <li><i class="fa fa-bars"></i><a href="ui-tabs.html">Pending Jobs</a></li>
                      </ul>
                  </li>
                  <li class="menu-item-has-children dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
