                    ...
                    <div class="dropdown-menu" aria-labelledby="message">
                        ...
                        <a class="dropdown-item media" href="#">
                            <span class="photo media-left"><img alt="avatar"
                                    src="{{ asset('assets/dist_3/assets/images/avatar/1.jpg') }}"></span>
                        ...
                        <a class="dropdown-item media" href="#">
                            <span class="photo media-left"><img alt="avatar"
                                    src="{{ asset('assets/dist_3/assets/images/avatar/2.jpg') }}"></span>
                            <div class="message media-body">
                        ...
                        <a class="dropdown-item media" href="#">
                            <span class="photo media-left"><img alt="avatar"
                                    src="{{ asset('assets/dist_3/assets/images/avatar/3.jpg') }}"></span>
                            <div class="message media-body">
                        ...
                        <a class="dropdown-item media" href="#">
                            <span class="photo media-left"><img alt="avatar"
                                    src="{{ asset('assets/dist_3/assets/images/avatar/4.jpg') }}"></span>
                            <div class="message media-body">
                ...
                <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true"
                    ...
                    @if (Auth::user()->avatar == 'user.png')
                        <img class="user-avatar rounded-circle mx-auto d-block"
                            src="{{Storage::url('uploads/avatars/users/' . Auth::user()->avatar)}}"
                            alt="Card image cap">
                    @else
                        <img class="user-avatar rounded-circle mx-auto d-block"
                            src="{{Storage::url('uploads/avatars/users/' . Auth::id() . '/' . Auth::user()->avatar)}}"
                            alt="Card image cap">
                    @endif
                </a>
