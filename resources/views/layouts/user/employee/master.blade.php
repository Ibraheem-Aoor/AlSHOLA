...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ asset('assets/dist_2/img/favicon.ico') }}" rel="icon">
    ...
    <link href="{{ asset('assets/dist_2/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css') }}"
        rel="stylesheet" />
...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <!-- Spinner End -->
        @include('layouts.user.employee.sidebar')
        <div class="content">
    ...
    <script src="{{ asset('assets/dist_2/lib/tempusdominus/js/moment.min.js') }}"></script>
    <script src="{{ asset('assets/dist_2/lib/tempusdominus/js/moment-timezone.min.js') }}"></script>
    <script src="{{ asset('assets/dist_2/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js') }}"></script>
