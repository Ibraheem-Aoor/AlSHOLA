                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li><a href="#exampleModal_5"
                                                            ...
                                                            data-toggle="modal" href="#">Send Note</a>
                                                    </li>
                                                    <li><a href="#exampleModal_6"
                                                             class="dropdown-item badge bg-primary"
                                                             data-id="{{$application->id}}"
                                                            data-toggle="modal" href="#">Reject</a>
                                                    </li>
                                                    <li><a href="#exampleModal_5"
                                                             class="dropdown-item badge bg-primary"
                                                             data-id="{{$application->id}}"
                                                            data-toggle="modal" href="#">Accept</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('employer.application.accept') }}" method="POST">
                                ...
                                <div class="form-group col-sm-6 mb-3">
                                    <label for="" style="font-weight: 600">JobL Number: </label>
                                    &nbsp; &nbsp; <input type="text" class="form-control" id="title">
                                </div>
                                <div class="form-group col-sm-6 text-center" style="width: 100%">
                                    <button type="submit" class="btn btn-outline-primary"><i class="fa fa-submit"></i>
